...
#
# The emcc call ill be fed the actual raylib library file. That stuff will end
# up in env.o
#
...
flags="-sINITIAL_HEAP=524288 -sSTACK_SIZE=131072 -sALLOW_MEMORY_GROWTH=1 -sUSE_GLFW=3 -sWASM_BIGINT -sWARN_ON_UNDEFINED_SYMBOLS=0 -sASSERTIONS -sEXPORTED_RUNTIME_METHODS=["HEAPF32"] --shell-file source/main_web/index_template.html --preload-file assets"
